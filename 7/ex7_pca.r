...
## Initialization
rm(list=ls())
sources <- c("kMeansInitCentroids.r","plotDataPoints.r","plotProgresskMeans.r","runkMeans.r",
             "displayData.r","featureNormalize.r","../lib/bsxfun.r",
             "computeCentroids.r","findClosestCentroids.r","projectData.r","recoverData.r","pca.r")

sources <- c(sources[1:7], paste0(substr(sources[8:12], 1, nchar(sources[8:12])-2), '-solution.r'))
...
# alternatively load the stored dataset
load('bird_small.rda')
