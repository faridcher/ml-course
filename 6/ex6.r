...
sources <- c("plotData.r", "svmPredict.r","visualizeBoundary.r",
             ...
             "../lib/meshgrid.r","../lib/bsxfun.r",
             "gaussianKernel.r","dataset3Params.r")
# Uncomment the following, if you want to execute the solution scripts.
sources <- c(sources[1:8], paste0(substr(sources[9:10], 1, nchar(sources[9:10])-2), '-solution.r'))
...
# Try different SVM Parameters here. takes about 2 min
